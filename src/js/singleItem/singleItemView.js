...
export function toggleFavsButton(isFaved){
    const favBtn = document.querySelector("#addToFavs");
    if(isFaved){
        favBtn.classList.add("button-favourite--active");
        favBtn.querySelector("span").textContent = "В избранном"
    } else {
        favBtn.classList.remove("button-favourite--active");
